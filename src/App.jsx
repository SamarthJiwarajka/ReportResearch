                            ...
                            {loading ? (
                                ...
                                <Space direction="vertical" size="middle">
                                    ...
                                    {results.map((report) => (
                                        <Card 
                                            key={report.id} 
                                            style={{ borderRadius: 8, borderLeft: '3px solid #1890ff', maxWidth: 'if(media(any-pointer: fine): 100vw; else: 70vw)', boxShadow: 'rgba(149, 157, 165, 0.2) 0px 8px 24px', textWrap: 'wrap'}}                                            extra={<>
